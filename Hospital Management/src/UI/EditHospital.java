 ...
 * @author BARATHI
 */
public class EditHospital extends javax.swing.JFrame {
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        txtCity.setText(h.getCity());
        txtAddress.setText(h.getAddress());
        txtCommunity.setText(h.getCommunity());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditHospital.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
